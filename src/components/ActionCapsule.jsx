...
const actionColors = {
  F: 'linear-gradient(180deg, #7a8799 0%, #304467 100%)',

  C: 'linear-gradient(180deg, #e8c55b 0%, #5e5026 100%)',

  R25: 'linear-gradient(180deg, #eb7979 0%, #b65f5f 100%)',
  R33: 'linear-gradient(180deg, #ab5656 0%, #8c4848 100%)',
  R50: 'linear-gradient(180deg, #854545 0%, #361c1c 100%)',
  R66: 'linear-gradient(180deg, #763e3e 0%, #482525 100%)',
  R75: 'linear-gradient(180deg, #913e3e 0%, #291111 100%)',
  R100: 'linear-gradient(180deg, #9f1414 0%, #511616 100%)',

  A: 'linear-gradient(180deg, #ce3419 0%, #4f2611 100%)',
};
...
function normalizeSegments(actions) {
...
function ActionCapsule({ actions, label = '' }) {
  const segments = normalizeSegments(actions);
